...
class UserModel extends DbConnect
{
    ...
    {
        $this->request = $this->connection->prepare("INSERT INTO $this->table VALUES (NULL, :user_isAdmin, :user_username, :user_email, :user_password)");
    ...
    {
        $this->request = $this->connection->prepare("SELECT * FROM $this->table WHERE user_email = :user_email");
    ...
    {
        $this->request = $this->connection->prepare("UPDATE $this->table VALUES (NULL, :user_isAdmin, :user_username, :user_email, :user_password)");
    ...
    {
        $this->request = $this->connection->prepare("DELETE FROM $this->table WHERE user_email = :user_email");
