...
<div class="container d-flex m-3">
    ...
    <div class="col-6 card p-3 text-secondary">
        ...
        <p class="mt-3 mb-3">
            <b class="text-warning me-3"><i class="fas fa-star m-2"></i><?= $film->getFilmRating() ?></b>
            <b class="text-secondary me-3"><i class="fas fa-clock"></i> <?= $film->getFilmLengthMin() ?> min.</b>
        </p>
        <p class="m-2">
            ...
            ?>
                <div class="col-12 mt-4">
                    ...
                    <ul class="list-group col-6">
                        ...
                        ?>
                            <label class="rounded m-1 radioCard">
